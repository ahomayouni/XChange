Rails.application.routes.draw do
  ...
  put 'borrow_requests/:id/approve', to: 'borrow_requests#approve', as: 'borrow_approve'
  put '/users/:id/borrow_requests/:id', to: 'borrow_requests#decline', as: 'borrow_decline'
