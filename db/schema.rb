...
ActiveRecord::Schema.define(version: 2018_11_29_150642) do
  ...
  create_table "borrow_requests", force: :cascade do |t|
    ...
    t.integer "status"
    t.datetime "start_borrowing"
    t.datetime "end_borrowing"
  end
  ...
  create_table "live_searches", force: :cascade do |t|
    t.integer "user_id"
    t.string "title"
    t.text "category"
