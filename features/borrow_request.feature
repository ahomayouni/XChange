...
@javascript
Scenario: As a lender, when someone sends me a borrow request, I must be able to view and approve it. The borrower then will receive a notification saying that his/her item has been approved. Then after the two parties (borrower and lender) has met , the lender has to mark the item as borrowed in his/her dashboard. 
Given that I am able to login as `cucumber_tester` and view my dashboard
Given that I already have listings and other users seeded
When I click listings in the top header
And I wait for "5" seconds
...
@javascript
Scenario: As a lender, when someone sends me a borrow request, I must be able to view and approve it. The borrower then will receive a notification saying that his/her item has been approved. Then after the two parties (borrower and lender) has met , the lender has to mark the item as borrowed in his/her dashboard. Once the item has been borrowed, when the user goes to the dashboard , he/she should be able to return the item.
Given that I am able to login as `cucumber_tester` and view my dashboard
Given that I already have listings and other users seeded
When I click listings in the top header
And I wait for "5" seconds
